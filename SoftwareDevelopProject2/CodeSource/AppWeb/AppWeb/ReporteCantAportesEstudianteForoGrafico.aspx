<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="ReporteCantAportesEstudianteForoGrafico.aspx.vb" Inherits="AppWeb.ReporteCantAportesEstudianteForoGrafico" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server"><asp:DropDownList ID="ddGrupos" runat="server" AppendDataBoundItems="True" 
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reportes\ReporteCantAportesEstudianteForoGrafico.rdlc">
         <DataSources>
