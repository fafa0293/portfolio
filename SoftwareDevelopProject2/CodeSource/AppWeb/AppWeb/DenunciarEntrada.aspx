<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="DenunciarEntrada.aspx.vb" Inherits="AppWeb.DenunciarEntrada" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="SidebarContent" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
<h1>Denunciar Entrada</h1>
    <div class="spaced clear">
        <label class="form-row">
	        <asp:Label ID="Label1" runat="server" Text="De:"></asp:Label>
	        <asp:TextBox ID="txtDe" runat="server" Enabled="False"></asp:TextBox>
        </label>
        <label class="form-row">
	        <asp:Label ID="Label2" runat="server" Text="Para:"></asp:Label>
	        <asp:TextBox ID="txtPara" runat="server" Enabled="False"></asp:TextBox>
        </label>
        <label class="form-row">
