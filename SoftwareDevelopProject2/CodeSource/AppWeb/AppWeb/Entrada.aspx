         ...
         <asp:Repeater ID="listaTemasBlog" runat="server"> 
            <ItemTemplate>
                <div class="temas pull-left">
                    <a class="blog" href="Blog.aspx?ID=<%# idUser %>&Tema=<%# Container.DataItem.Id%>">
...
<h1>
    <a href="BuscarBlog.aspx">Blogs</a> &raquo; <asp:HyperLink ID="HyperLink1" runat="server"></asp:HyperLink>
    &raquo; <asp:Label ID="Label5" runat="server" Text="Label"></asp:Label>
</h1>
<hr />
<div class="entrada">
    <div>
    ...
    <div class="clear">
        <asp:Label ID="Label6" runat="server" CssClass="temas pull-left date">Temas&nbsp;&nbsp;</asp:Label>
    ...
    <div class="clear clearfix" style="margin-top: 64px;">
        <h1 class="pull-left ">Comentarios</h1>
        <a href="#" id="agregar-comentario" class="link-button pull-right">Agregar comentario</a>
    </div>
    <div id="form-agregar-comentario" style="margin-top: 6px; padding: 10px;" class="clear clearfix">
            <asp:TextBox ID="txtComentario" runat="server" Width="100%" TextMode="MultiLine" Height="60px"></asp:TextBox><br />
