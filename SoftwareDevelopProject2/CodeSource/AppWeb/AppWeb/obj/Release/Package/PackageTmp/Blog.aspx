         ...
         <asp:Repeater ID="listaTemasBlog" runat="server"> 
            <ItemTemplate>
                <div class="temas pull-left">
                    <a class="blog" href="Blog.aspx?ID=<%# Request.QueryString("ID") %>&Tema=<%# Container.DataItem.Id%>">
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h1 class="pull-left"><a href="BuscarBlog.aspx">Blogs</a> &raquo; Blog de <asp:Label runat="server" ID="lblNombreUsuario" Text=""></asp:Label></h1>
...
<div id="form-agregar-entrada" class="clear clearfix">
    <label class="form-row">
        ...
        <asp:TextBox ID="TextBox1" runat="server" cssClass="required"></asp:TextBox>
    </label>
    <label class="form-row">
         <asp:Label ID="Label4" runat="server" Text="Temas"></asp:Label> 
         <asp:TextBox ClientIDMode="Static" ID="txtTemas" runat="server" cssClass="required"></asp:TextBox>
    </label>
    <label class="form-row">
        <asp:Label ID="Label1" runat="server" Text="Contenido"></asp:Label> 
        <asp:TextBox ID="TextBox2" runat="server" TextMode="MultiLine" cssClass="required"></asp:TextBox>
    </label>
...
<asp:Repeater ID="listaEntradas" runat="server">
        <ItemTemplate>
            ...
            <a class="entrada-blog" href="Entrada.aspx?ID=<%# Container.DataItem.IdEntrada%>">
                <h1 class="pull-left"><%# HttpUtility.HtmlEncode(Container.DataItem.Titulo)%> </h1>
