...
<html>
	<head>
		...
		<!--Fecha de creación: 12.04.2012 5:50pm-->
	...
	<body>
		...
		<div>
			<center><table >
				<tr>
					<td align="center"><font face="Verdana" size="4"><b>Bienvenido<?php echo $_SESSION['sNombreChofer'];?>.<br>Usted es un usuario con permisos de secretario.</b></font></td>
				</tr>
			</table></center>
		</div>
		</div>
